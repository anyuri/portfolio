...
<div class="bg-orange-50 py-20">
    <div class="container mx-auto text-zinc-900 flex flex-row items-center">
        ...
        <div class="flex-1">
            <img class="ml-auto" src="{{ '/assets/images/iphone_2display.png' | absolute_path }}">
        </div>
    </div>
</div>
...
<div class="container mx-auto my-12 text-zinc-900">
    ...
    <div class="flex bg-indigo-100 p-8 rounded-md gap-10 items-center">
        <div class="flex-1">
            ...
            <img class="mr-auto" src="{{ '/assets/images/painpoint_1.png' | absolute_path }}">
        </div>
        <div class="flex-1">
    ...
    <div class="flex bg-indigo-100 p-8 rounded-md gap-10 items-center">
        <div class="flex-1">
            <p class="text-white font-normal bg-gray-400 px-3">Example : Competitive flower shop website</p>
            <img class="mr-auto" src="{{ '/assets/images/painpoint_2.png' | absolute_path }}">
        </div>
        <div class="flex-1">
    ...
    <div class="flex bg-indigo-100 p-8 rounded-md gap-10 items-center">
        <div class="flex-1">
            <p class="text-white font-normal bg-gray-400 px-3">Example : Competitive flower shop website</p>
            <img class="mr-auto" src="{{ '/assets/images/painpoint_3.png' | absolute_path }}">
        </div>
        <div class="flex-1">
...
<div class="container flex flex-row mx-auto bg-indigo-100 p-8 rounded-md gap-x-8">
    <div class="bg-white p-8 rounded-md flex-1">
        <img class="mx-auto border border-zinc-400 mb-8" src="{{ '/assets/images/solution2_image1.png' | absolute_path }}">
    ...
    <div class="bg-white p-8 rounded-md flex-1">
        <img class="mx-auto border border-zinc-400 mb-8" src="{{ '/assets/images/solution2_image2.png' | absolute_path }}">
    ...
    <div class="bg-white p-8 rounded-md flex-1">
        <img class="mx-auto border border-zinc-400 mb-8" src="{{ '/assets/images/solution2_image3.png' | absolute_path }}">
...
<div class="container flex flex-col mx-auto bg-indigo-100 p-8 rounded-md gap-10">
    <div class="bg-white p-8 rounded-md">
        ...
        <div class="flex mt-7 items-center">
            <div class="flex flex-1 justify-center"><img class="border border-zinc-400" src="{{ '/assets/images/solution3_image1.png' | absolute_path }}"/></div>
            <div class="flex flex-col items-center max-w-[247px] px-2">
                <img class="w-full" src="{{ '/assets/images/longarrow.svg' | absolute_path }}"/>
            ...
            <div class="flex flex-1 justify-center"><img class="border border-zinc-400" src="{{ '/assets/images/solution3_image2.png' | absolute_path }}"/></div>
        </div>
    </div>
    <div class="bg-white p-8 rounded-md flex flex-row justify-between">
        <div>
            ...
            <img class="mx-auto border border-zinc-400 mt-7" src="{{ '/assets/images/solution3_image3.png' | absolute_path }}">
        </div>
        ...
        <div>
            ...
            <img class="mx-auto border border-zinc-400 mt-7" src="{{ '/assets/images/solution3_image4.png' | absolute_path }}">
            </div>
        </div>
    </div>
...
<div class="container mx-auto my-12 text-zinc-900 border-y pb-12">
    ...
    <img class="mx-auto mt-7" src="{{ '/assets/images/prototype.gif' | absolute_path }}">
</div>
